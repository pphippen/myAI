...
export const CHAT_HEADER: string = `Parker's Capstone AI Assistant`;
export const MESSAGE_PLACEHOLDER: string = `[MESSAGE PLACEHOLDER]`;
export const FOOTER_MESSAGE: string = `Customized AI by Parker 2025`;
export const CLEAR_BUTTON_TEXT: string = `Erase Chat`;
export const PAGE_TITLE: string = `Parker's AI`;
